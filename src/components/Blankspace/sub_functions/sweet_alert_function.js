...
// Contains functions to call Sweet Alert 2 messages and Toasts (i.e UI elment like notifications in Laravel)
...
export const sweet_alert_externalFile = {
	...
	*/
    ...
    /*
    |--------------------------------------------------------------------------
	| Function to call Sweet Alert 2 Toasts (i.e UI elment like notifications in Laravel)
